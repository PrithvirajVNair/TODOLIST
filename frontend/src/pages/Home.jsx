      ...
      <div className="min-h-screen">
        <div className="grid md:grid-cols-2 min-h-screen justify-center items-center bg-blue-400/5 md:pt-0 pt-15 sm:px-10 md:px-20">
          <div className="flex flex-col gap-5 p-5">
            ...
            <p className="sm:text-lg max-md:text-center text-black/60">
            ...
            <div className="flex max-md:justify-center items-center">
              <a href="/register" className="bg-blue-400 border text-white py-1 px-2 rounded-lg hover:bg-blue-500 cursor-pointer duration-200 active:scale-97 me-3 font-semibold">
                Start Free Today
              </a>
              <a href="#about" className="bg-white border border-black/20 me-2 py-1 px-2 rounded-lg hover:bg-white/90 cursor-pointer duration-200 active:scale-97 font-semibold">
                Learn More
              </a>
            </div>
        ...
        <section id="about" className="min-h-screen px-5 sm:px-10 md:px-20 flex flex-col justify-center items-center gap-5">
          <h1 className="text-2xl sm:text-3xl font-semibold text-center pt-20">
            Everything You Need to Stay Productive
          </h1>
          <p className="sm:text-lg text-black/60 text-center py-3">
            Powerful features to help you manage your tasks effectively
          </p>
          <div className="grid sm:grid-cols-4">
            <div className="m-1 md:m-5">
              <div className="border sm:min-h-60 border-black/10 hover:border-blue-400/50 rounded-xl p-3 md:p-5 hover:shadow-xl duration-200">
                <FontAwesomeIcon
                  icon={faList}
                  className="p-3 bg-blue-400/20 text-blue-400 rounded-lg"
                />
                <h2 className="text-lg md:text-2xl">Task Management</h2>
                <p className="md:text-lg text-black/60">
          ...
          <div className="flex justify-center items-center">
            <div className="md:w-200 p-5 bg-blue-400 rounded-xl flex justify-center items-center flex-col gap-3 mb-5">
              ...
              <a href="/register" className="bg-white text-blue-400 font-semibold py-1 px-2 rounded-lg hover:bg-white/90 cursor-pointer duration-200 active:scale-97">
                Create Your Account
              </a>
            </div>
          </div>
